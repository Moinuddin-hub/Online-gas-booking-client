...
const FeatureData=[
        ...
        { 
         ...
         description: 'Provide real-time order tracking, allowing users to monitor the status of their delivery.Send notifications or alerts to users regarding the delivery status',
