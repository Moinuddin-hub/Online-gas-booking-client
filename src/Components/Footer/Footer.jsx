...
const Footer = () => {
    return (
        <>
            <footer className="px-4 divide-y font-serif dark:bg-gray-800 dark:text-gray-100">
	...
	<div className="py-6 text-lg text-center bg-purple-950 text-white dark:text-gray-400">© 1968 Company Co. All rights reserved.</div>
</footer>
        </>
    );
};
