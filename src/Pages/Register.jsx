        ...
        <div className="flex  w-[1000px] shadow-2xl p-8 rounded-xl mx-auto dark:bg-gray-900 dark:text-gray-100 bg-slate-300 gap-8">
          <div className="w-[500px] h-[500px]">
            ...
            >
              ...
              <button className="block w-full btn btn-primary p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400">
                Sign up
              </button>
            </form>
            ...
            <p className="text-xs text-center sm:px-4 dark:text-gray-400">
