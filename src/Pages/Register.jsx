   ...
   if (password.length < 6) {
	...
	<form  onSubmit={handleSubmit} noValidate="" action="" className="space-y-4">
		<div className="space-y-1 text-sm">
			...
			<input type="text" onChange={(e)=>setName(e.target.value)}  name="name" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md  dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
		</div>
		...
		<button  className="block w-full btn btn-primary p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400">Sign up</button>
	</form>
